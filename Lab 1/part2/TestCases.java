...
public class TestCases
{
	...
	public void testRotate90() {
		...
		Point Point2 = point.rotate90();
		assertEquals(Newpoint.getX(), Point2.getX(), DELTA);
		assertEquals(Newpoint.getY(), Point2.getY(), DELTA);
	}
	...
	assertEquals("Unexpected non-final fields", 2, nonFinalFields.size());
    }
}
