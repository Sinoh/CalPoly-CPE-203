...
public class TestCases
{
	...
	assertArrayEquals(
	    new int[] {16, 25, 36},
        SimpleArray.squareAll(new int[] {4, 5, 6}));
    ...
    @Test
    public void testBetterLoop3() { assertFalse(BetterLoop.contains(new int[] {1, 2, 3, 4, 5}, 6)); }
    ...
    {
    List<String> expected = Arrays.asList("Justin");
    Map<String, List<Course>> courseListsByStudent = new HashMap<>();

    courseListsByStudent.put("Justin",
            Arrays.asList(
                    new Course("CPE 123", 4),
                    new Course("CPE 101", 4),
                    new Course("CPE 202", 4),
                    new Course("CPE 248", 4),
                    new Course("PHYS 244", 4),
                    new Course("CPE 357", 4)));
    courseListsByStudent.put("Jeffery",
            Arrays.asList(
                    new Course("CPE 203", 4),
                    new Course("EE 211", 4),
                    new Course("ENGL 149", 4),
                    new Course("CHEM 124", 4)));
    courseListsByStudent.put("Chino",
            Arrays.asList(
                    new Course("CPE 123", 4),
                    new Course("CPE 203", 4),
                    new Course("CPE 471", 4),
